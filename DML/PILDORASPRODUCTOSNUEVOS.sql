...
CÓDIGOARTÍCULO VARCHAR( 100 ),
SECCIÓN VARCHAR( 100 ),
NOMBREARTÍCULO VARCHAR( 100 ),
PRECIO VARCHAR( 100 ),
FECHA VARCHAR( 100 ),
IMPORTADO VARCHAR( 100 ),
PAÍSDEORIGEN VARCHAR( 100 ),
FOTO VARCHAR( 100 )
);

/* INSERT QUERY */
INSERT INTO TABLE_NAME( CÓDIGOARTÍCULO,SECCIÓN,NOMBREARTÍCULO,PRECIO,FECHA,IMPORTADO,PAÍSDEORIGEN,FOTO )
VALUES
(
